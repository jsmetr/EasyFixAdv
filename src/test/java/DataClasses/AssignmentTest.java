...
public class AssignmentTest {
    ...
    public void testGetCustomer() {
        ...
        Assignment instance = new Assignment(new Device(),"title",LocalDateTime.now().toString(),"customer","clerk","technician",1);
    ...
    public void testGetDeadline() {
        ...
        Assignment instance = new Assignment(new Device(),"title",dl.toString(),"customer","clerk","technician",1);
