...
public class AssignmentTest {
    ...
    public void testGetCustomer() {
        ...
        Assignment instance = new Assignment(new Device(),LocalDateTime.now().toString(),"customer","clerk","technician",1);
    ...
    public void testGetDeadline() {
        ...
        Assignment instance = new Assignment(new Device(),dl.toString(),"customer","clerk","technician",1);
